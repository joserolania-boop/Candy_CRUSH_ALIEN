...
- **Nuevos Assets**: Descarga de 12 fichas espaciales altamente diferenciadas (Planetas, UFOs, Astronautas, Estrellas, Cristales, Rayos, Escudos, Estaciones, Meteoros, Agujeros Negros y Naves) para asegurar que cada tipo de ficha sea fácilmente reconocible por su forma y color.
