...
- **Nuevos Assets**: Refinado de la colección de 12 fichas para maximizar la distinción visual. Se han eliminado las rocas/meteoros y se ha dejado un único tipo de nave espacial, mezclando los mejores assets de Kenney (Planetas, Astronautas, Cristales, Estrellas, Rayos, Escudos, Agujeros Negros, Aliens y UFOs).
